...
const MetricEditor = () => {
  ...
  // Dark mode state and theme system
  const [isDarkMode, setIsDarkMode] = useState(false);

  // Theme colors based on the dark mode interface
  const theme = {
    light: {
      primaryBg: '#ffffff',
      secondaryBg: '#f9fafb', 
  ...
  const handleDarkModeToggle = () => setIsDarkMode(true);
  const handleLightModeToggle = () => setIsDarkMode(false);
          ...
          <InfoSection style={{
            ...
            <ButtonsContainer>
              ...
              <NonFunctionalButton 
                ...
                style={{
                  backgroundColor: 'transparent',
                  color: isDarkMode ? '#3DA00B' : currentTheme.secondaryText,
                  border: isDarkMode ? '1px solid #3DA00B' : '1px solid var(--button-border-color, #e3e8ee)',
                  flex: isDarkMode ? '1' : '0 0 auto'
                }}
              >
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <g mask="url(#mask0_1935_93649)">
                    <rect width="12" height="12" fill={isDarkMode ? "#2B8700" : "#474E5A"}/>
                  </g>
                </svg>
                Code
              </NonFunctionalButton>
